...
export declare function isNonNullType(type: GraphQLInputType): type is GraphQLNonNull<GraphQLInputType>;
export declare function isNonNullType(type: GraphQLOutputType): type is GraphQLNonNull<GraphQLOutputType>;
export declare function isNonNullType(type: unknown): type is GraphQLNonNull<GraphQLType>;
export declare function assertNonNullType(type: unknown): GraphQLNonNull<GraphQLType>;
/**
 ...
 */
export type GraphQLOutputType = GraphQLScalarType | GraphQLObjectType | GraphQLInterfaceType | GraphQLUnionType | GraphQLEnumType | GraphQLList<GraphQLOutputType> | GraphQLNonNull<GraphQLScalarType | GraphQLObjectType | GraphQLInterfaceType | GraphQLUnionType | GraphQLEnumType | GraphQLList<GraphQLOutputType>>;
 ...
 */
export type GraphQLNullableType = GraphQLScalarType | GraphQLObjectType | GraphQLInterfaceType | GraphQLUnionType | GraphQLEnumType | GraphQLInputObjectType | GraphQLList<GraphQLType>;
