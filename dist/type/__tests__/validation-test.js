...
import { assertEnumType, assertInputObjectType, assertInterfaceType, assertObjectType, assertScalarType, assertUnionType, GraphQLEnumType, GraphQLInputObjectType, GraphQLInterfaceType, GraphQLList, GraphQLNonNull, GraphQLObjectType, GraphQLUnionType, } from '../definition';
...
describe('Type System: Enum types must be well defined', () => {
    ...
    it('rejects an Enum type with incorrectly named values', () => {
        const schema = schemaWithFieldType(new GraphQLEnumType({
            name: 'SomeEnum',
            values: {
                __badName: {},
            },
