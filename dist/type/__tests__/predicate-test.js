...
describe('Type predicates', () => {
    ...
    describe('isInterfaceType', () => {
        ...
        it('returns false for wrapped interface type', () => {
            ...
            expect(() => assertInterfaceType(new GraphQLList(InterfaceType))).to.throw();
        });
    ...
    describe('isInputObjectType', () => {
        ...
        it('returns false for wrapped input object type', () => {
            expect(isInputObjectType(new GraphQLList(InputObjectType))).to.equal(false);
            expect(() => assertInputObjectType(new GraphQLList(InputObjectType))).to.throw();
        });
    ...
    describe('isListType', () => {
        ...
        it('returns false for a non-list wrapped type', () => {
            expect(isListType(new GraphQLNonNull(new GraphQLList(ObjectType)))).to.equal(false);
            expect(() => assertListType(new GraphQLNonNull(new GraphQLList(ObjectType)))).to.throw();
        });
    });
    describe('isNonNullType', () => {
        ...
        it('returns false for a not non-null wrapped type', () => {
            expect(isNonNullType(new GraphQLList(new GraphQLNonNull(ObjectType)))).to.equal(false);
            expect(() => assertNonNullType(new GraphQLList(new GraphQLNonNull(ObjectType)))).to.throw();
        });
    });
    ...
    describe('isCompositeType', () => {
        ...
        it('returns false for wrapped non-composite type', () => {
            ...
            expect(() => assertCompositeType(new GraphQLList(InputObjectType))).to.throw();
        });
    });
    describe('isAbstractType', () => {
        ...
        it('returns false for wrapped abstract type', () => {
            ...
            expect(() => assertAbstractType(new GraphQLList(InterfaceType))).to.throw();
        });
    ...
    describe('isNullableType', () => {
        ...
        it('returns true for list of non-null types', () => {
            expect(isNullableType(new GraphQLList(new GraphQLNonNull(ObjectType)))).to.equal(true);
        ...
        it('returns false for non-null types', () => {
            ...
            expect(() => assertNullableType(new GraphQLNonNull(ObjectType))).to.throw();
        });
    });
    describe('getNullableType', () => {
        ...
        it('unwraps non-null type', () => {
            expect(getNullableType(new GraphQLNonNull(ObjectType))).to.equal(ObjectType);
        });
    });
    ...
    describe('getNamedType', () => {
        ...
        it('unwraps deeply wrapper types', () => {
            expect(getNamedType(new GraphQLNonNull(new GraphQLList(new GraphQLNonNull(ObjectType))))).to.equal(ObjectType);
        });
    });
