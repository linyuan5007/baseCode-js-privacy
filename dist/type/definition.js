...
export class GraphQLList {
    constructor(ofType) {
        devAssert(isType(ofType), `Expected ${inspect(ofType)} to be a GraphQL type.`);
        this.ofType = ofType;
    }
...
export class GraphQLNonNull {
    constructor(ofType) {
        devAssert(isNullableType(ofType), `Expected ${inspect(ofType)} to be a GraphQL nullable type.`);
        this.ofType = ofType;
    }
    get [Symbol.toStringTag]() {
...
export class GraphQLScalarType {
    constructor(config) {
        ...
        devAssert(config.specifiedByURL == null ||
        ...
        if (config.parseLiteral) {
            devAssert(typeof config.parseValue === 'function' &&
...
export class GraphQLObjectType {
    constructor(config) {
        ...
        devAssert(config.isTypeOf == null || typeof config.isTypeOf === 'function', `${this.name} must provide "isTypeOf" as a function, ` +
...
function defineFieldMap(config) {
    ...
    return mapValue(fieldMap, (fieldConfig, fieldName) => {
        ...
        devAssert(fieldConfig.resolve == null || typeof fieldConfig.resolve === 'function', `${config.name}.${fieldName} field resolver must be a function if ` +
...
export class GraphQLInterfaceType {
    constructor(config) {
        ...
        devAssert(config.resolveType == null || typeof config.resolveType === 'function', `${this.name} must provide "resolveType" as a function, ` +
...
function defineEnumValues(typeName, valueMap /* <T> */) {
    ...
    return Object.entries(valueMap).map(([valueName, valueConfig]) => {
        devAssert(isPlainObj(valueConfig), `${typeName}.${valueName} must refer to an object with a "value" key ` +
