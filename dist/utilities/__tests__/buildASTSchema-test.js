...
import { assertDirective, GraphQLDeprecatedDirective, GraphQLIncludeDirective, GraphQLOneOfDirective, GraphQLSkipDirective, GraphQLSpecifiedByDirective, } from '../../type/directives';
...
function expectASTNode(obj) {
    invariant((obj === null || obj === void 0 ? void 0 : obj.astNode) != null);
...
describe('Schema Builder', () => {
    ...
    it('Match order of default types and directives', () => {
        ...
        expect(Object.keys(sdlSchema.getTypeMap())).to.deep.equal(Object.keys(schema.getTypeMap()));
    });
    it('Empty type', () => {
        const sdl = dedent `
      type EmptyType
    ...
    `;
        expect(() => buildSchema(sdl, { assumeValidSDL: true })).to.throw('Unknown type: "UnknownType".');
    });
    it('Rejects invalid AST', () => {
        // @ts-expect-error (First parameter expected to be DocumentNode)
        expect(() => buildASTSchema(null)).to.throw('Must provide valid Document AST');
        // @ts-expect-error
