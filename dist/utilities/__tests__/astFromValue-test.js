...
describe('astFromValue', () => {
    ...
    it('converts Int values to Int ASTs', () => {
        ...
        expect(() => astFromValue(123.5, GraphQLInt)).to.throw('Int cannot represent non-integer value: 123.5');
    ...
    it('converts string values to Enum ASTs if possible', () => {
        ...
        // Note: case sensitive
        expect(() => astFromValue('hello', myEnum)).to.throw('Enum "MyEnum" cannot represent value: "hello"');
    ...
    it('converts array values to List ASTs', () => {
        expect(astFromValue(['FOO', 'BAR'], new GraphQLList(GraphQLString))).to.deep.equal({
            kind: 'ListValue',
            values: [
        ...
        expect(astFromValue(['HELLO', 'GOODBYE'], new GraphQLList(myEnum))).to.deep.equal({
            kind: 'ListValue',
            values: [
        ...
        expect(astFromValue(listGenerator(), new GraphQLList(GraphQLInt))).to.deep.equal({
            kind: 'ListValue',
            values: [
