...
describe('Type System: build schema from introspection', () => {
    ...
    `);
        it('throws when introspection is missing __schema property', () => {
            ...
            expect(() => buildClientSchema(null)).to.throw('Invalid or incomplete introspection result. Ensure that you are passing "data" property of introspection response and no "errors" was returned alongside: null.');
            // @ts-expect-error
      ...
      `);
        ...
        it('throws when type reference is missing name', () => {
            ...
            expect(() => buildClientSchema(introspection)).to.throw('Unknown type reference: { kind: "OBJECT" }.');
        });
        it('throws when missing kind', () => {
            const introspection = introspectionFromSchema(dummySchema);
            const queryTypeIntrospection = introspection.__schema.types.find(({ name }) => name === 'Query');
            invariant((queryTypeIntrospection === null || queryTypeIntrospection === void 0 ? void 0 : queryTypeIntrospection.kind) === 'OBJECT');
            // @ts-expect-error
        ...
        it('Legacy support for interfaces with null as interfaces field', () => {
            ...
            invariant((someInterfaceIntrospection === null || someInterfaceIntrospection === void 0 ? void 0 : someInterfaceIntrospection.kind) === 'INTERFACE');
            // @ts-expect-error
        ...
        it('throws when missing possibleTypes', () => {
            ...
            invariant((someUnionIntrospection === null || someUnionIntrospection === void 0 ? void 0 : someUnionIntrospection.kind) === 'UNION');
            // @ts-expect-error
        ...
        it('throws when missing enumValues', () => {
            ...
            invariant((someEnumIntrospection === null || someEnumIntrospection === void 0 ? void 0 : someEnumIntrospection.kind) === 'ENUM');
            // @ts-expect-error
        ...
        it('throws when missing inputFields', () => {
            ...
            invariant((someInputObjectIntrospection === null || someInputObjectIntrospection === void 0 ? void 0 : someInputObjectIntrospection.kind) === 'INPUT_OBJECT');
            // @ts-expect-error
