...
describe('ValidationContext', () => {
    it('can be Object.toStringified', () => {
        ...
        expect(Object.prototype.toString.call(astContext)).to.equal('[object ASTValidationContext]');
        const sdlContext = new SDLValidationContext(ast, schema, onError);
        expect(Object.prototype.toString.call(sdlContext)).to.equal('[object SDLValidationContext]');
        const context = new ValidationContext(schema, ast, typeInfo, onError);
        expect(Object.prototype.toString.call(context)).to.equal('[object ValidationContext]');
    });
});
