...
(0, mocha_1.describe)('Introspection', () => {
    (0, mocha_1.it)('executes an introspection query', () => {
    ...
    `);
        const source = (0, getIntrospectionQuery_1.getIntrospectionQuery)({
            descriptions: false,
            specifiedByUrl: true,
            directiveIsRepeatable: true,
        });
        const result = (0, graphql_1.graphqlSync)({ schema, source });
    ...
    (0, mocha_1.it)('introspects on input object', () => {
        const schema = (0, buildASTSchema_1.buildSchema)(`
    ...
    `;
        (0, chai_1.expect)((0, graphql_1.graphqlSync)({ schema, source })).to.deep.equal({
            data: {
                __type: {
                    kind: 'INPUT_OBJECT',
    ...
    (0, mocha_1.it)('introspects any default value', () => {
        const schema = (0, buildASTSchema_1.buildSchema)(`
    ...
    (0, mocha_1.it)('supports the __type root field', () => {
        const schema = (0, buildASTSchema_1.buildSchema)(`
      type Query {
        someField: String
      }
    ...
    (0, mocha_1.it)('identifies deprecated fields', () => {
        const schema = (0, buildASTSchema_1.buildSchema)(`
      type Query {
    ...
    (0, mocha_1.it)('respects the includeDeprecated parameter for fields', () => {
        const schema = (0, buildASTSchema_1.buildSchema)(`
      type Query {
        nonDeprecated: String
        deprecated: String @deprecated(reason: "Removed in 1.0")
    ...
    (0, mocha_1.it)('identifies deprecated args', () => {
        const schema = (0, buildASTSchema_1.buildSchema)(`
      type Query {
        someField(
          nonDeprecated: String
    ...
    (0, mocha_1.it)('respects the includeDeprecated parameter for args', () => {
        const schema = (0, buildASTSchema_1.buildSchema)(`
      type Query {
        someField(
          nonDeprecated: String
    ...
    (0, mocha_1.it)('identifies deprecated enum values', () => {
        const schema = (0, buildASTSchema_1.buildSchema)(`
      enum SomeEnum {
        NON_DEPRECATED
    ...
    (0, mocha_1.it)('respects the includeDeprecated parameter for enum values', () => {
        const schema = (0, buildASTSchema_1.buildSchema)(`
      enum SomeEnum {
        NON_DEPRECATED
        DEPRECATED @deprecated(reason: "Removed in 1.0")
    ...
    (0, mocha_1.it)('identifies deprecated for input fields', () => {
        const schema = (0, buildASTSchema_1.buildSchema)(`
      input SomeInputObject {
        nonDeprecated: String
        deprecated: String @deprecated(reason: "Removed in 1.0")
    ...
    (0, mocha_1.it)('respects the includeDeprecated parameter for input fields', () => {
        const schema = (0, buildASTSchema_1.buildSchema)(`
      input SomeInputObject {
        nonDeprecated: String
        deprecated: String @deprecated(reason: "Removed in 1.0")
    ...
    (0, mocha_1.it)('identifies oneOf for input objects', () => {
        const schema = (0, buildASTSchema_1.buildSchema)(`
    ...
    (0, mocha_1.it)('returns null for oneOf for other types', () => {
        const schema = (0, buildASTSchema_1.buildSchema)(`
    ...
    (0, mocha_1.it)('fails as expected on the __type root field without an arg', () => {
        const schema = (0, buildASTSchema_1.buildSchema)(`
      type Query {
        someField: String
      }
    ...
    `;
        (0, expectJSON_1.expectJSON)((0, graphql_1.graphqlSync)({ schema, source })).toDeepEqual({
            errors: [
                {
    ...
    (0, mocha_1.it)('exposes descriptions', () => {
        const schema = (0, buildASTSchema_1.buildSchema)(`
      """Enum description"""
      enum SomeEnum {
        """Value description"""
    ...
    (0, mocha_1.it)('executes an introspection query without calling global resolvers', () => {
        const schema = (0, buildASTSchema_1.buildSchema)(`
      type Query {
        someField: String
      }
    `);
        ...
        function fieldResolver(_1, _2, _3, info) {
            chai_1.expect.fail(`Called on ${info.parentType.name}::${info.fieldName}`);
        }
        ...
        (0, chai_1.expect)(result).to.not.have.property('errors');
    });
});
