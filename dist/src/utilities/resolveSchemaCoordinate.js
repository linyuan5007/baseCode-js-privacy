...
function resolveSchemaCoordinate(schema, schemaCoordinate) {
    return resolveASTSchemaCoordinate(schema, (0, parser_1.parseSchemaCoordinate)(schemaCoordinate));
}
/**
 * TypeCoordinate : Name
 */
...
function resolveMemberCoordinate(schema, schemaCoordinate) {
    ...
    if (!type) {
        throw new Error(`Expected ${(0, inspect_1.inspect)(typeName)} to be defined as a type in the schema.`);
    }
    if (!(0, definition_1.isEnumType)(type) &&
        !(0, definition_1.isInputObjectType)(type) &&
        !(0, definition_1.isObjectType)(type) &&
        !(0, definition_1.isInterfaceType)(type)) {
        throw new Error(`Expected ${(0, inspect_1.inspect)(typeName)} to be an Enum, Input Object, Object or Interface type.`);
    }
...
function resolveArgumentCoordinate(schema, schemaCoordinate) {
    ...
    if (!(0, definition_1.isObjectType)(type) && !(0, definition_1.isInterfaceType)(type)) {
        throw new Error(`Expected ${(0, inspect_1.inspect)(typeName)} to be an object type or interface type.`);
    }
    ...
    if (field == null) {
        throw new Error(`Expected ${(0, inspect_1.inspect)(fieldName)} to exist as a field of type ${(0, inspect_1.inspect)(typeName)} in the schema.`);
    }
...
function resolveDirectiveArgumentCoordinate(schema, schemaCoordinate) {
    ...
    if (!directive) {
        throw new Error(`Expected ${(0, inspect_1.inspect)(directiveName)} to be defined as a directive in the schema.`);
    }
