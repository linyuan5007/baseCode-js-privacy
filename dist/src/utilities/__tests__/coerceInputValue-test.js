...
(0, mocha_1.describe)('coerceInputValue', () => {
    ...
    (0, mocha_1.describe)('for GraphQLInputObject', () => {
        const DeepObject = new definition_1.GraphQLInputObjectType({
            name: 'DeepObject',
            fields: {
        ...
        (0, mocha_1.it)('returns an error for an array type', () => {
        ...
        (0, mocha_1.it)('returns an error for an array type on a nested field', () => {
    ...
    (0, mocha_1.describe)('for GraphQLInputObject that isOneOf', () => {
        const TestInputObject = new definition_1.GraphQLInputObjectType({
            name: 'TestInputObject',
            fields: {
                foo: { type: scalars_1.GraphQLInt },
                bar: { type: scalars_1.GraphQLInt },
            },
            isOneOf: true,
        });
        ...
        (0, mocha_1.it)('returns an error if more than one field is specified', () => {
        ...
        (0, mocha_1.it)('returns an error the one field is null', () => {
