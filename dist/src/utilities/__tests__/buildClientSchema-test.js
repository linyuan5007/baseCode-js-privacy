...
(0, mocha_1.describe)('Type System: build schema from introspection', () => {
    ...
    (0, mocha_1.it)('builds a schema with @oneOf directive', () => {
        const sdl = (0, dedent_1.dedent) `
      type Query {
    ...
    `);
      ...
      `);
        ...
        (0, mocha_1.it)('throws when type reference is missing name', () => {
            ...
            (0, chai_1.expect)(() => (0, buildClientSchema_1.buildClientSchema)(introspection)).to.throw('Unknown type reference: { kind: "OBJECT" }.');
        });
        (0, mocha_1.it)('throws when missing kind', () => {
            const introspection = (0, introspectionFromSchema_1.introspectionFromSchema)(dummySchema);
            const queryTypeIntrospection = introspection.__schema.types.find(({ name }) => name === 'Query');
            (0, invariant_1.invariant)(queryTypeIntrospection?.kind === 'OBJECT');
            // @ts-expect-error
        ...
        (0, mocha_1.it)('Legacy support for interfaces with null as interfaces field', () => {
            ...
            (0, invariant_1.invariant)(someInterfaceIntrospection?.kind === 'INTERFACE');
            // @ts-expect-error
        ...
        (0, mocha_1.it)('throws when missing possibleTypes', () => {
            ...
            (0, invariant_1.invariant)(someUnionIntrospection?.kind === 'UNION');
            // @ts-expect-error
        ...
        (0, mocha_1.it)('throws when missing enumValues', () => {
            ...
            (0, invariant_1.invariant)(someEnumIntrospection?.kind === 'ENUM');
            // @ts-expect-error
        ...
        (0, mocha_1.it)('throws when missing inputFields', () => {
            ...
            (0, invariant_1.invariant)(someInputObjectIntrospection?.kind === 'INPUT_OBJECT');
            // @ts-expect-error
