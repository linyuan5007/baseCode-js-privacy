...
function expectASTNode(obj) {
    (0, invariant_1.invariant)(obj?.astNode != null);
...
(0, mocha_1.describe)('Schema Builder', () => {
    ...
    (0, mocha_1.it)('Maintains @include, @skip & @specifiedBy', () => {
        ...
        (0, chai_1.expect)(schema.getDirective('oneOf')).to.equal(directives_1.GraphQLOneOfDirective);
    });
    ...
    `);
        ...
        (0, chai_1.expect)(schema.getDirective('oneOf')).to.not.equal(directives_1.GraphQLOneOfDirective);
    });
    (0, mocha_1.it)('Adding directives maintains @include, @skip, @deprecated, @specifiedBy, and @oneOf', () => {
        const schema = (0, buildASTSchema_1.buildSchema)(`
      directive @foo(arg: Int) on FIELD
    `);
        (0, chai_1.expect)(schema.getDirectives()).to.have.lengthOf(6);
        ...
        (0, chai_1.expect)(schema.getDirective('oneOf')).to.not.equal(undefined);
    });
