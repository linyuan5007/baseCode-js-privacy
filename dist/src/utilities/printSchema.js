...
function printSchema(schema) {
    return printFilteredSchema(schema, (n) => !(0, directives_1.isSpecifiedDirective)(n), isDefinedType);
}
function printIntrospectionSchema(schema) {
    return printFilteredSchema(schema, directives_1.isSpecifiedDirective, introspection_1.isIntrospectionType);
}
...
function printDeprecated(reason) {
    ...
    if (reason !== directives_1.DEFAULT_DEPRECATION_REASON) {
        const astValue = (0, printer_1.print)({ kind: kinds_1.Kind.STRING, value: reason });
...
function printSpecifiedByURL(scalar) {
    ...
    const astValue = (0, printer_1.print)({
...
function printDescription(def, indentation = '', firstInBlock = true) {
    ...
    const blockString = (0, printer_1.print)({
        kind: kinds_1.Kind.STRING,
        value: description,
        block: (0, blockString_1.isPrintableAsBlockString)(description),
    });
