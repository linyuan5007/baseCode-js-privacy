...
function expectErrors(queryStr) {
    return (0, harness_1.expectValidationErrorsWithSchema)(schemaWithDirectives, KnownDirectivesRule_1.KnownDirectivesRule, queryStr);
}
function expectValid(queryStr) {
    expectErrors(queryStr).toDeepEqual([]);
}
function expectSDLErrors(sdlStr, schema) {
    return (0, harness_1.expectSDLValidationErrors)(schema, KnownDirectivesRule_1.KnownDirectivesRule, sdlStr);
}
function expectValidSDL(sdlStr, schema) {
    expectSDLErrors(sdlStr, schema).toDeepEqual([]);
}
const schemaWithDirectives = (0, buildASTSchema_1.buildSchema)(`
  type Query {
    dummy: String
  }
...
`);
const schemaWithSDLDirectives = (0, buildASTSchema_1.buildSchema)(`
...
`);
(0, mocha_1.describe)('Validate: Known directives', () => {
    (0, mocha_1.it)('with no directives', () => {
        expectValid(`
      query Foo {
        name
        ...Frag
    ...
    (0, mocha_1.it)('with standard directives', () => {
        expectValid(`
      {
        human @skip(if: false) {
          name
    ...
    (0, mocha_1.it)('with unknown directive', () => {
        expectErrors(`
      {
    ...
    (0, mocha_1.it)('with many unknown directives', () => {
        expectErrors(`
      {
        __typename @unknown
        human @unknown {
    ...
    (0, mocha_1.it)('with well placed directives', () => {
        expectValid(`
    ...
    (0, mocha_1.it)('with misplaced directives', () => {
        expectErrors(`
    ...
    (0, mocha_1.describe)('within SDL', () => {
        (0, mocha_1.it)('with directive defined inside SDL', () => {
            expectValidSDL(`
        type Query {
          foo: String @test
        }
      ...
      `);
        ...
        (0, mocha_1.it)('with standard directive', () => {
            expectValidSDL(`
        type Query {
      ...
      `);
        ...
        (0, mocha_1.it)('with overridden standard directive', () => {
            expectValidSDL(`
        schema @deprecated {
          query: Query
        }
      ...
      `);
        ...
        (0, mocha_1.it)('with directive defined in schema extension', () => {
      ...
      `);
        ...
        (0, mocha_1.it)('with directive used in schema extension', () => {
            const schema = (0, buildASTSchema_1.buildSchema)(`
        directive @test on OBJECT
      ...
      `);
        ...
        (0, mocha_1.it)('with unknown directive in schema extension', () => {
            const schema = (0, buildASTSchema_1.buildSchema)(`
        type Query {
          foo: String
        }
