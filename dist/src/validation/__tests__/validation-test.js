...
(0, mocha_1.describe)('operation and variable definition descriptions', () => {
    (0, mocha_1.it)('validates operation with description and variable descriptions', () => {
        const schema = (0, buildASTSchema_1.buildSchema)('type Query { field(a: Int, b: String): String }');
        const query = `
      ...
      `;
        ...
        const errors = (0, validate_1.validate)(schema, ast);
