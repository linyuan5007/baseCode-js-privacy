...
(0, mocha_1.describe)('Validate: Values of correct type', () => {
    ...
    (0, mocha_1.describe)('Valid oneOf input object value', () => {
        (0, mocha_1.it)('Exactly one field', () => {
            expectValid(`
        {
          complicatedArgs {
      ...
      `);
        ...
        (0, mocha_1.it)('Exactly one non-nullable variable', () => {
            expectValid(`
        query ($string: String!) {
          complicatedArgs {
    ...
    (0, mocha_1.describe)('Invalid oneOf input object value', () => {
        (0, mocha_1.it)('Invalid field type', () => {
            expectErrors(`
        {
          complicatedArgs {
      ...
      `).toDeepEqual([
        ...
        (0, mocha_1.it)('Exactly one null field', () => {
            expectErrors(`
        {
          complicatedArgs {
      ...
      `).toDeepEqual([
        ...
        (0, mocha_1.it)('More than one field', () => {
            expectErrors(`
        {
          complicatedArgs {
