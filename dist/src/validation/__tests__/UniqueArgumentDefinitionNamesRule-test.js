...
function expectSDLErrors(sdlStr) {
    return (0, harness_1.expectSDLValidationErrors)(undefined, UniqueArgumentDefinitionNamesRule_1.UniqueArgumentDefinitionNamesRule, sdlStr);
}
function expectValidSDL(sdlStr) {
    expectSDLErrors(sdlStr).toDeepEqual([]);
}
(0, mocha_1.describe)('Validate: Unique argument definition names', () => {
    (0, mocha_1.it)('no args', () => {
        expectValidSDL(`
      type SomeObject {
        someField: String
      }
    ...
    (0, mocha_1.it)('multiple arguments', () => {
        expectValidSDL(`
      type SomeObject {
        someField(
          foo: String
    ...
    (0, mocha_1.it)('duplicating arguments', () => {
        expectSDLErrors(`
      type SomeObject {
        someField(
          foo: String
