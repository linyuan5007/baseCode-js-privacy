...
(0, mocha_1.describe)('Validates OneOf Input Objects', () => {
    (0, mocha_1.it)('Allows exactly one non-nullable variable', () => {
        expectValid(`
      query ($string: String!) {
        complicatedArgs {
    ...
    (0, mocha_1.it)('Undefined variable in oneOf input object', () => {
        expectErrors(`
      {
        complicatedArgs {
    ...
    (0, mocha_1.it)('Forbids one nullable variable', () => {
        expectErrors(`
      query ($string: String) {
        complicatedArgs {
          oneOfArgField(oneOfArg: { stringField: $string })
