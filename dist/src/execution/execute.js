...
function buildExecutionContext(args) {
    ...
    const coercedVariableValues = (0, values_1.getVariableValues)(schema, variableDefinitions, rawVariableValues ?? {}, { maxErrors: options?.maxCoercionErrors ?? 50 });
    ...
    try {
        ...
        if ((0, isPromise_1.isPromise)(completed)) {
            ...
            return completed.then(undefined, (rawError) => {
                const error = (0, locatedError_1.locatedError)(rawError, fieldNodes, (0, Path_1.pathToArray)(path));
        ...
        try {
            ...
            if ((0, isPromise_1.isPromise)(completedItem)) {
                ...
                return completedItem.then(undefined, (rawError) => {
                    const error = (0, locatedError_1.locatedError)(rawError, fieldNodes, (0, Path_1.pathToArray)(itemPath));
