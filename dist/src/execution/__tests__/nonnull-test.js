...
(0, mocha_1.describe)('Execute: handles non-nullable types', () => {
    ...
    (0, mocha_1.describe)('Handles multiple errors for a single response position', () => {
        (0, mocha_1.it)('nullable and non-nullable root fields throw nested errors', async () => {
            const query = `
        {
          promiseNonNullNest {
            syncNonNull
      ...
      `;
        ...
        (0, mocha_1.it)('a nullable root field throws a slower nested error after a non-nullable root field throws a nested error', async () => {
            const query = `
        {
          promiseNonNullNest {
            syncNonNull
      ...
      `;
            ...
            (0, invariant_1.invariant)(result.errors !== undefined);
            const initialErrors = [...result.errors];
            for (let i = 0; i < 5; i++) {
                // eslint-disable-next-line no-await-in-loop
                await (0, resolveOnNextTick_1.resolveOnNextTick)();
            }
            (0, expectJSON_1.expectJSON)(initialErrors).toDeepEqual(result.errors);
        });
        (0, mocha_1.it)('nullable and non-nullable nested fields throw nested errors', async () => {
            const query = `
        {
          syncNest {
            promiseNonNullNest {
      ...
      `;
        ...
        (0, mocha_1.it)('a nullable nested field throws a slower nested error after a non-nullable nested field throws a nested error', async () => {
            const query = `
        {
          syncNest {
            promiseNonNullNest {
