...
(0, mocha_1.describe)('AST node predicates', () => {
    ...
    (0, mocha_1.it)('isSchemaCoordinateNode', () => {
        (0, chai_1.expect)([
            kinds_1.Kind.TYPE_COORDINATE,
            kinds_1.Kind.MEMBER_COORDINATE,
            kinds_1.Kind.ARGUMENT_COORDINATE,
            kinds_1.Kind.DIRECTIVE_COORDINATE,
            kinds_1.Kind.DIRECTIVE_ARGUMENT_COORDINATE,
        ].every((kind) => (0, predicates_1.isSchemaCoordinateNode)({ kind }))).to.equal(true);
    });
});
