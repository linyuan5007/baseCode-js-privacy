...
(0, mocha_1.describe)('Printer: Query document', () => {
    ...
    (0, mocha_1.it)('prints fragment', () => {
        const printed = (0, printer_1.print)((0, parser_1.parse)('"Fragment description" fragment Foo on Bar { baz }'));
        (0, chai_1.expect)(printed).to.equal((0, dedent_1.dedent) `
    ...
    (0, mocha_1.it)('prints schema coordinates', () => {
        (0, chai_1.expect)((0, printer_1.print)((0, parser_1.parseSchemaCoordinate)('Name'))).to.equal('Name');
        (0, chai_1.expect)((0, printer_1.print)((0, parser_1.parseSchemaCoordinate)('Name.field'))).to.equal('Name.field');
        (0, chai_1.expect)((0, printer_1.print)((0, parser_1.parseSchemaCoordinate)('Name.field(arg:)'))).to.equal('Name.field(arg:)');
        (0, chai_1.expect)((0, printer_1.print)((0, parser_1.parseSchemaCoordinate)('@name'))).to.equal('@name');
        (0, chai_1.expect)((0, printer_1.print)((0, parser_1.parseSchemaCoordinate)('@name(arg:)'))).to.equal('@name(arg:)');
        (0, chai_1.expect)((0, printer_1.print)((0, parser_1.parseSchemaCoordinate)('__Type'))).to.equal('__Type');
        (0, chai_1.expect)((0, printer_1.print)((0, parser_1.parseSchemaCoordinate)('Type.__metafield'))).to.equal('Type.__metafield');
        (0, chai_1.expect)((0, printer_1.print)((0, parser_1.parseSchemaCoordinate)('Type.__metafield(arg:)'))).to.equal('Type.__metafield(arg:)');
    });
    (0, mocha_1.it)('throws syntax error for ignored tokens in schema coordinates', () => {
        (0, chai_1.expect)(() => (0, printer_1.print)((0, parser_1.parseSchemaCoordinate)('# foo\nName'))).to.throw('Syntax Error: Invalid character: "#"');
        (0, chai_1.expect)(() => (0, printer_1.print)((0, parser_1.parseSchemaCoordinate)('\nName'))).to.throw('Syntax Error: Invalid character: U+000A.');
        (0, chai_1.expect)(() => (0, printer_1.print)((0, parser_1.parseSchemaCoordinate)('Name .field'))).to.throw('Syntax Error: Invalid character: " "');
    });
});
