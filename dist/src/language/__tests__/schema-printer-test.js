...
(0, mocha_1.describe)('Printer: SDL document', () => {
    ...
    (0, mocha_1.it)('prints kitchen sink without altering ast', () => {
        const ast = (0, parser_1.parse)(kitchenSinkSDL_1.kitchenSinkSDL, { noLocation: true });
