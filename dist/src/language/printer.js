 ...
 */
function print(ast) {
    return (0, visitor_1.visit)(ast, printDocASTReducer);
}
...
const printDocASTReducer = {
    ...
    StringValue: {
        leave: ({ value, block: isBlockString }) => isBlockString ? (0, blockString_1.printBlockString)(value) : (0, printString_1.printString)(value),
    },
