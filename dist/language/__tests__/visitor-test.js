...
describe('Visitor', () => {
    ...
    it('allows for editing on enter', () => {
        ...
        expect(ast).to.deep.equal(parse('{ a, b, c { a, b, c } }', { noLocation: true }));
        expect(editedAST).to.deep.equal(parse('{ a,    c { a,    c } }', { noLocation: true }));
    });
    ...
    it('ignores false returned on leave', () => {
        ...
        expect(returnedAST).to.deep.equal(parse('{ a, b, c { a, b, c } }', { noLocation: true }));
    });
