...
import { isConstValueNode, isDefinitionNode, isExecutableDefinitionNode, isSchemaCoordinateNode, isSelectionNode, isTypeDefinitionNode, isTypeExtensionNode, isTypeNode, isTypeSystemDefinitionNode, isTypeSystemExtensionNode, isValueNode, } from '../predicates';
...
describe('AST node predicates', () => {
    ...
    it('isSchemaCoordinateNode', () => {
        ...
        ].every((kind) => isSchemaCoordinateNode({ kind }))).to.equal(true);
    });
});
